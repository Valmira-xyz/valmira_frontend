      ...
      <div className="grid gap-6 p-4 md:p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Common questions about Valmira platform and services
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="what-is-valmira">
                ...
                <AccordionContent>
                  ...
                  creating, monitoring, and optimizing your crypto trading
                  strategies with advanced automation features.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="how-to-start">
                ...
                <AccordionContent>
                  To get started, connect your wallet using the button in the
                  sidebar. Once connected, you can create your first project by
                  navigating to the Projects section and clicking on "Create New
                  Project". Follow the guided setup process to configure your
                  trading bot.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="supported-chains">
                ...
                <AccordionContent>
                  Valmira currently supports Ethereum, Binance Smart Chain,
                  Polygon, Arbitrum, and Optimism. We're continuously working to
                  add support for more networks based on user demand.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="bot-types">
                ...
                <AccordionContent>
                  ...
                  Liquidation Snipe Bots, Volume Bots, Bundle Snipe Bots, and
                  Holder Bots. Each bot type is designed for specific trading
              ...
              <AccordionItem value="bot-security">
                ...
                <AccordionContent>
                  ...
                  permissions you grant, and we never have access to your
                  private keys. We use industry-standard security practices and
                  regular audits to ensure the platform remains secure.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="bot-fees">
                ...
                <AccordionContent>
                  Valmira uses a subscription model with different tiers based
                  on your needs. Each tier provides access to different bot
                  types and features. Additionally, there's a small performance
                  fee on profitable trades. Check our pricing page for detailed
                  information.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="bot-performance">
                ...
                <AccordionContent>
                  ...
                  monitor key metrics like profit/loss, number of trades,
                  success rate, and more. You can also set up notifications for
                  important events and performance milestones.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
