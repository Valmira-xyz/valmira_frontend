...
import { WalletInfo } from './bundle-sniping-dialog';
...
interface DistributeNativeDialogProps {
  open: boolean;
...
export function DistributeNativeDialog({
  open,
  onOpenChange,
  wallets,
  distributeAmount,
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Distribute Extra {nativeCurrency}</AlertDialogTitle>
          <AlertDialogDescription>
            Enter the amount of {nativeCurrency} to distribute evenly among{' '}
            {walletCount} selected sniping wallet{walletCount !== 1 ? 's' : ''}.
          </AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          {/* nativeCurrency Amount input with percentage buttons */}
